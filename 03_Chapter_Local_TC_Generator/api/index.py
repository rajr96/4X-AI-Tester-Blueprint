...
candidate_templates = [
    src_root / "templates" / "test_case_template.md",
    src_root / "Templates" / "test_case_template.md",
    project_root / "templates" / "test_case_template.md",
    project_root / "Templates" / "test_case_template.md",
]
TEMPLATE_PATH = next((path for path in candidate_templates if path.exists()), candidate_templates[0])
